...
public class UserController {
	...
	public String showNotification(Authentication authentication, Model theModel,
			@RequestParam(name = "display", required = false) String display) {
		User theUser = userService.findById(authentication.getName());
	...
	public String responseNotification(Authentication authentication,
			@ModelAttribute("responseNotification") @Valid Notification notification, BindingResult bindingResult,
			RedirectAttributes attr, @RequestParam(name = "display", required = true) String display) {
		if (bindingResult.hasErrors()) {
	...
	public String saveNotification(Authentication authentication,
			@ModelAttribute("responseNotification") @Valid Notification notification, BindingResult bindingResult,
			RedirectAttributes attr) {
		if (bindingResult.hasErrors()) {
			attr.addFlashAttribute("org.springframework.validation.BindingResult.responseNotification", bindingResult);
